...
{
    [DbContext(typeof(JAFU20BankContext))]
    [Migration("20220204141038_AddingCheckedTransactions")]
    partial class AddingCheckedTransactions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bank.Models.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bank.Models.Disposition", b =>
                {
                    b.Property<int>("DispositionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bank.Models.Frequency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FreqeuncyLabel")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("Bank.Models.Gender", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bank.Models.Transaction", b =>
                {
                    ...
                    b.Property<bool>("LaunderingChecked")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Bank.Models.Card", b =>
                {
                    b.HasOne("Bank.Models.Disposition", "Disposition")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("Bank.Models.Transaction", b =>
                {
                    b.HasOne("Bank.Models.Account", "AccountNavigation")
