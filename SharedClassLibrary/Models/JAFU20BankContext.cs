...
{
    public partial class JAFU20BankContext : IdentityDbContext<IdentityUser>
    {
        public JAFU20BankContext()
        {
        }

        public JAFU20BankContext(DbContextOptions<JAFU20BankContext> options)
            : base(options)
        {
        }
        ...
        // This List "Users" isnt actually used anymore since we added Identity user
...
//                optionsBuilder.UseSqlServer("Server=tcp:sql-richard.database.windows.net,1433;Initial Catalog=JAFU20-Bank;Persist Security Info=False;User ID=barmybrit;Password=*duke100;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
//            }
//        }
